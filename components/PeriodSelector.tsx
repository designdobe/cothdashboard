...
const PeriodSelector: React.FC<PeriodSelectorProps> = ({ months, selectedPeriod, onPeriodChange }) => {
  ...
  const commonSelectClasses = "bg-gray-900 border border-primary text-gray-200 font-medium text-sm rounded-full focus:ring-primary focus:border-primary block w-full pl-5 pr-10 py-2.5 transition-colors duration-200 appearance-none hover:border-primary focus:outline-none focus:ring-1";
